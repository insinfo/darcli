...
const selectValueAcessor = ExistingProvider.forToken(
  ngValueAccessor,
...
class SelectControlValueAccessorWithEqual extends Object
  ...
  SelectControlValueAccessorWithEqual(HtmlElement element)
  ...
  bool Function(Object? o1, Object? o2) _compareWith = _equals;
...
class CustomNgSelectOption implements OnDestroy {
  ...
  final SelectControlValueAccessorWithEqual? _select;
