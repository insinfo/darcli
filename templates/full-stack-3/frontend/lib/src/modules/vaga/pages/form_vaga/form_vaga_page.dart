...
import 'package:sibem_frontend/src/modules/empregador/pages/lista_empregador/lista_empregador_page.dart';
...
class FormVagaPage implements OnActivate {
  ...
  @ViewChild('modalEmpregador')
  CustomModalComponent? modalEmpregador;

  @ViewChild('listaEmpregador')
  ListaEmpregadorPage? listaEmpregador;
  ...
  void openModalEmpregador() {
    modalEmpregador?.open();
    listaEmpregador?.load();
  }

  void onSelectEmpregador(Empregador empregador) {
    item.idEmpregador = empregador.idPessoa;
    item.empregadorNome = empregador.nome;
    item.empregadorContato = empregador.contato;
    modalEmpregador?.close();
  }
