...
extension ResponseContextExtensions on ResponseContext {
  ...
  void responseJson(Object? value, {int statusCode = 200, int? totalRecords}) {
    var v = value is String
        ? value
        : jsonEncode(value, toEncodable: SaliCoreUtils.customJsonEncode);
  ...
  void responseSuccess(
    ...
    var v = jsonEncode({'message': message},
        toEncodable: SaliCoreUtils.customJsonEncode);
    this.statusCode = statusCode;
    this.headers['Content-Type'] = 'application/json;charset=utf-8';
    this.write(v);
  }
  ...
  void responseModel(SerializeBase object,
    ...
    this.headers['Content-Type'] = 'application/json;charset=utf-8';
    var json =
        jsonEncode(object.toMap(), toEncodable: SaliCoreUtils.customJsonEncode);
    this.write(json);
  }

  // Future<void> responsePageAsync(Future<DataFrame> dataPage,
  //     {int statusCode = 200}) async {
  //  return responsePage(await dataPage);
  // }
