...
class TreeViewNode {
  ...
  /// Children
  List<TreeViewNode> _children = <TreeViewNode>[];
  ...
  bool hasChilds() {
    return this.treeViewNodes.isNotEmpty == true;
  }
  ...
  bool finded(String searchQuery, TreeViewNode item) {
    var item_title =
        SaliCoreUtils.removerAcentos(item.treeViewNodeLabel).toLowerCase();
    return item_title.contains(searchQuery);
  }
