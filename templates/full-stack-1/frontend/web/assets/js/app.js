...
const App = function () {
    ...
    const sidebarMainToggle = function () {
        ...
        sidebarMainDesktopToggler.forEach(function (toggler) {
            toggler.addEventListener('click', function (e) {
                //console.log("sidebarMainToggle sidebarMainDesktopToggler");
                e.preventDefault();
    ...
    window.onload = function () {
        ...
        document.addEventListener("click", function (e) {
            const link = e.target.closest(`.${navContainerClass}:not(.${navScrollSpyClass}) .${navSubmenuContainerClass} > .${navLinkClass}:not(.${navLinkDisabledClass})`); // Or any other selector.
...
//     App.initAfterLoad();
// });
function limitlessInitCore() {
    console.log('limitlessInitCore');
    App.initCore();
}

function limitlessInitAfterLoad() {
    App.initAfterLoad();
}
