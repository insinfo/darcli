...
import 'package:new_sali_frontend/src/shared/utils/frontend_utils.dart';
import 'package:pdf_fork/pdf.dart';
import 'package:pdf_fork/widgets.dart';
import 'package:intl/intl.dart';

Future<void> geraPdfRelatorioProcesso(
  List<Auditoria> auditorias) async {
  final logoUrlSvg = '/assets/images/brasao_editado_1.svg';
  var svgRaw = await FrontUtils.getNetworkTextFile(logoUrlSvg);
